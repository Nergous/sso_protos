...
const file_sso_auth_proto_rawDesc = "" +
	"\n" +
	"\x0esso/auth.proto\x12\x04auth\"\x84\x01\n" +
	...
	"\x06app_id\x18\x03 \x01(\rR\x05appId\"W\n" +
	"\rLoginResponse\x12!\n" +
	...
	"\x05valid\x18\x02 \x01(\bR\x05valid2\xa8\x02\n" +
	"\x04Auth\x129\n" +
	...
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponseB\x16Z\x14nergous.sso.v2;ssov2b\x06proto3"
...
var file_sso_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
var file_sso_auth_proto_depIdxs = []int32{
	...
	7, // 4: auth.Auth.ValidateToken:input_type -> auth.ValidateTokenRequest
	...
	3, // 8: auth.Auth.Refresh:output_type -> auth.LoginResponse
	8, // 9: auth.Auth.ValidateToken:output_type -> auth.ValidateTokenResponse
